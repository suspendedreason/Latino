...
Feeding troughs, \& all the faces \\
Turned w/in, toward shout \& flag \& \\
Colored card w/ preassigned allegiance.
...
\newpage % Force graphic to upper-column

\includegraphics[width=0.8\columnwidth]{parana-kitchen}

\secdiv

\input{"locations/Brazil/scenes/Paranapiacaba"}

\includegraphics[width=0.8\columnwidth]{paranapiacaba-home}
...
% \includegraphics[width=0.8\columnwidth]{carnival-2}
...
--Are You Sick and Tired of Being Sick and Tired Boy? \\
